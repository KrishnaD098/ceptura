  ...
  return (
    <div className="relative bg-[#EFF0F0] min-h-screen pt-16 py-12 px-4">
      ...
      <div className="absolute top-4 left-4">
        <Link to="/" className="text-2xl font-bold text-[#132030] hover:text-[#4A515D] transition duration-300">
          Ceptura
        </Link>
      </div>

      <div className="absolute top-4 right-4 bg-[#132030] text-white p-2 rounded-md shadow-lg">
        <Link to="/SignIn" className="text-xl font-bold hover:text-[#4A515D] transition duration-300">
          Login
        </Link>
      </div>
